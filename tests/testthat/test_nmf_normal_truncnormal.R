...
test_that("nmf_normal_truncnormal works with sparse Poisson data generating function", {
    res <- nmf_normal_truncnormal(
        M, N = 5,
...
test_that("nmf_normal_truncnormal works with sparse Normal data generating function", {
    res <- nmf_normal_truncnormal(
        M, N = 5,
